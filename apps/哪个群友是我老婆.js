...
export async function 哪个群友是我老婆(e) {
    ...
    if (randomWife.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife.nickname}】 (${randomWife.user_id}) 哒哒哒！(健康使用要刷屏！注：9分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife2.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife2.nickname}】 (${randomWife2.user_id}) 哒哒哒！快点趁热入洞房吧！(健康使用不要刷屏！注：五分之一概率没有老婆)`
        ]
        e.reply(msg);
    ...
    if (randomWife3.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife3.nickname}】 (${randomWife3.user_id}) 哒哒哒！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
        Bot.logger.mark('第三个老婆最后发言时间：'+getMyDate(randomWife2.last_sent_time*1000));
        return true;
    }
    ...
    if (randomWife3.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            "今天你的群友老婆是",
            segment.image(`https://q1.qlogo.cn/g?b=qq&s=0&nk=${randomWife3.user_id}`),
            `【${randomWife4.nickname}】 (${randomWife3.user_id}) 啦啦啦！(健康使用不要刷屏！注：114514分之一概率没有老婆)`
        ]
        e.reply(msg);
        Bot.logger.mark('第四个老婆最后发言时间：'+getMyDate(randomWife2.last_sent_time*1000));
        return true;
    }
    ...
    if (randomWife4.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife5.nickname}】 (${randomWife4.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
        Bot.logger.mark('第五个老婆最后发言时间：'+getMyDate(randomWife3.last_sent_time*1000));
        return true;
    }
    ...
    if (randomWife5.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        let msg = [
            ...
            `【${randomWife4.nickname}】 (${randomWife3.user_id}) 啦啦啦！(健康使用不要刷屏！注：九分之一概率没有老婆)`
        ]
        e.reply(msg);
        Bot.logger.mark('第六个老婆最后发言时间：'+getMyDate(randomWife4.last_sent_time*1000));
        return true;
    }
    ...
    if (randomWife6.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        ...
        e.reply(msg);
        Bot.logger.mark('第七个老婆最后发言时间：'+getMyDate(randomWife3.last_sent_time*1000));
        return true;
    }
    ...
    if (randomWife7.last_sent_time>=(new Date().getTime() - 259200000)/1000){
        ...
        e.reply(msg);
        Bot.logger.mark('第八个老婆最后发言时间：'+getMyDate(randomWife5.last_sent_time*1000));
        return true;
    }
        e.reply("醒醒，你根本没有老婆！");
        return true;
